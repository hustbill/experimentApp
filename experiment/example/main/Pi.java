...
public class Pi {
    ...
    public static void main(String[] args) {
        Pi pi = new Pi();
        //pi.calculate(4, 10000, 10000);  //300 ms
    ...
    /**
     *  In its constructor we create a round-robin router to make it easier 
     *  to spread out the work evenly between the workers. 
     * @author hua.zhang
     *
     */
...
//            }
//        }), "master");
        //refer to :  http://stackoverflow.com/questions/20181516/solution-for-untypedactor-deprecated-in-akka-java-tutorial
        // cmbaxter's answer.
